...
const Hero = async () => {
  ...
  return user === null ? (
    <div className="px-4 mx-auto max-w-[100rem] sm:px-6 lg:px-8 dark:bg-gradient-to-b dark:from-black dark:to-gray-950">
      <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
        <div>
          ...
          <h1 className="mt-4 text-2xl font-bold dark:text-white text-black lg:mt-8 sm:text-4xl xl:text-6xl">
            Share resources instantly — so your audience can stay fully engaged.
          </h1>
          <p className="mt-4 text-base dark:text-white text-black lg:mt-8 sm:text-xl">

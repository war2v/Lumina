        ...
        <div className="py-12 px-4 md:px-12 ">
          ...
          <div className="grid gap-6 md:grid-cols-2 max-w-5xl mx-auto">
            <Card className="  border-destructive dark:border-red-800">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3 mb-3">
                  <AlertCircle className="text-destructive mt-1" size={22} />
            ...
            <Card className="border-success">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3 mb-3">
                  <Lightbulb className="text-success mt-1" size={22} />
                  <h3 className="text-xl font-semibold text-success dark:text-success">
                    Our Solution
                  </h3>
                </div>
                <p className="text-sm text-gray-700 dark:text-gray-300">

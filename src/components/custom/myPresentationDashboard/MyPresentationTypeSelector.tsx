...
interface SelectorProps {
  className?: string;
  public_presentations: Presentation[] | null;
  private_presentations: Presentation[] | null;
}

export const MyPresentationSelector = ({
  className,
  ...
  return (
    <div
      className={`grid grid-cols-1 items-center justify-center w-full ${className}`}
    >
      <div className="flex justify-center">
        <Button
          variant="outline"
          className={`rounded-r-none text-sm ${
            !public_type ? "opacity-50" : ""
          }`}
